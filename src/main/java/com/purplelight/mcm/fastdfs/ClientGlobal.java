package com.purplelight.mcm.fastdfs;
...
import com.purplelight.mcm.util.IniFileReader;
...
public class ClientGlobal {
	 ...
	 *            config filename
	 */
	public static void init(String conf_filename) throws FileNotFoundException, IOException, McmException {
		...
		if (szTrackerServers == null) {
			throw new McmException("item \"tracker_server\" in " + conf_filename + " not found");
		}
